...
(
    ...
    `joined_times`  int unsigned not null default 0 comment '参与次数',
    `joined_event`  varchar(64) not null default '' comment '参与的event，一个string的列表',
    `joined_organization`  varchar(64) not null default '' comment '参与的组织',
    ...
    `calibration_proof` varchar(64) not null default '' comment '级别证明图',
